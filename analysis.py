...
def assign_role(row):
    ...
    # Logik nach Legislaturperiode und Fraktionskürzel
...
# Titel und Achsen
plt.title("Durchschnittliche Anzahl an benutzten Wörtern in Bundestagsreden pro Jahr")
plt.xlabel("Jahr")
plt.ylabel("Wortanzahl")
plt.grid(True)
plt.legend(title="Rolle")
...
"""# **Emotions Analyse**
Überlegung statt dem Jahr die Wahlperiode als Zeitreferenz zu nutzen.
"""
...
for emotion in emotions:
    ...
    # Achsen & Titel
    plt.title(f"Durchschnittliche Ausprägung der Emotion: {emotion.replace('.norm','').capitalize()} pro Jahr")
    plt.xlabel("Jahr")
...
# Titel und Achsen
plt.title("Durchschnittliche Emotionsintensität von Bundestagsreden pro Jahr")
plt.xlabel("Jahr")
plt.ylabel("Emotionsintensität")
plt.grid(True)
plt.legend(title="Rolle")
plt.tight_layout()
plt.show()
